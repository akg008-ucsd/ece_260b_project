# Step 3: SRAM Synthesis -- sram_w16
...
if {[file exists template_sram_w16]} { exec rm -rf template_sram_w16 }
define_design_lib WORK -path ./template_sram_w16
...
# Read RTL
analyze -format verilog [list ${DESIGN_DIR}/memories/sram_w16.v]
